...
- Learning statistics (global + per-book study count and accuracy)
...
### v1.0.5 (2026-05-27)
- Perf: Editing a word only refreshes the word list, skipping the redundant stats API call
